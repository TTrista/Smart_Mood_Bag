...
abstract class AppLocalizations {
  ...
  /// No description provided for @bleDevice.
  ///
  /// In en, this message translates to:
  /// **'BLE Device'**
  ...
  /// No description provided for @hrvStatus.
  ///
  /// In en, this message translates to:
  /// **'HRV Status'**
  String get hrvStatus;

  /// No description provided for @greenRelaxed.
  ///
  /// In en, this message translates to:
  /// **'Green: Relaxed (HRV > 70)'**
  String get greenRelaxed;

  /// No description provided for @orangeWarning.
  ///
  /// In en, this message translates to:
  /// **'Orange: Moderate stress (30-70)'**
  String get orangeWarning;

  /// No description provided for @redAlert.
  ///
  /// In en, this message translates to:
  /// **'Red: High stress (<30)'**
  String get redAlert;

  /// No description provided for @lineChartArea.
  ///
  /// In en, this message translates to:
  /// **'Line chart area (to be implemented)'**
  String get lineChartArea;
